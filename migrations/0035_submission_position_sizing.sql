-- Bind structural position sizing to the persisted plan. The existing database
-- ceilings are intentionally broader framework guards; the frozen plan and its
-- exact EntryBudgetLimits provide the submission-specific bounds.
        ...
        CASE
            ...
            THEN jsonb_build_object(
                ...
                'strategy_profile', jsonb_build_object(
                    ...
                    'quantity', (policy_payload->>'maximum_quantity')::integer,
                    'maximum_debit', '2.25',
